                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('edit_main_section.update', ['id'=>$main_section->id]) }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input id="main_section_arabic_name" type="text" class="form-control @error('main_section_arabic_name') is-invalid @enderror" name="main_section_arabic_name" value="{{ $main_section->main_section_arabic_name }}" autocomplete="main_section_arabic_name" autofocus>
